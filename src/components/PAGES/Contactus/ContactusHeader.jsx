  ...
  <section className="mt-20 flex items-center justify-center ">
    <div className="mx-auto max-w-[43rem]">
      <div className="text-center">
        <h1 className="pb-3 text-4xl fade-in-down font-extrabold text-transparent  md:text-6xl bg-clip-text bg-gradient-to-r from-red-600 to-yellow-400 tracking-tight">
      ...
      <div className=" flex items-center justify-center gap-4">
        <a href="https://app.gather.town/invite?token=14Xcl0LAQlCAMrEenIcl"
          className="transform rounded-mdpx-6 rounded bg-gradient-to-r from-red-600 to-yellow-400 px-5 py-3 font-medium text-white transition-colors hover:from-pink-600 hover:to-orange-400">
