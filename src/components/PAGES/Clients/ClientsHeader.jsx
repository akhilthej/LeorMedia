      ...
      <div className="grid gap-5 md:grid-cols-2 md:gap-10 lg:gap-20">
        ...
        <div className="flex items-center">
          <div className="mx-auto md:mx-0">
            <h3 className="text-4xl fade-in-down font-extrabold text-transparent  md:text-6xl bg-clip-text bg-gradient-to-r from-red-600 via-orange-500 to-yellow-400 tracking-tight">Our Clients</h3>
        ...
        <Link to= '/contactus'><a
          class="transform rounded-mdpx-6 rounded bg-gradient-to-r from-red-600 via-orange-500 to-yellow-400 px-5 py-3 font-medium text-white transition-colors hover:from-red-600 hover:to-orange-400">
          Get in-touch
        </a></Link>
