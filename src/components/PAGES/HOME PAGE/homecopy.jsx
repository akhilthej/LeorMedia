...
<h2 className="mt-4 text-2xl text-orange-500 font-bold md:text-4xl">
  Services, We Provide
</h2>
</div>
...
<div className="" >
  ...
  <h2 className=" text-transparent bg-clip-text bg-gradient-to-r from-red-600 to-yellow-400 mt-3  leading-[4rem] tracking-tight">
  We develop our brand with passionate developers.
  </h2>
  <p className=" mt-6 text-black mx-2">
...
<div className="lg:flex lg:items-center">
  <div className="w-full space-y-12 lg:w-1/2 ">
    ...
    <div className="md:flex md:items-start md:-mx-4">
      <span className="inline-block p-2 ttext-black bg-yellow-500 rounded-xl md:mx-4 ">
        <svg
          xmlns="https://www.w3.org/2000/svg"
          className="w-6 h-6"
          fill="none"
