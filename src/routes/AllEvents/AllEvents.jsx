...
import { GlobalData} from '../../assets/GlodalData';
  ...
  <div className="flex flex-col items-center md:flex-row justify-center">
    ...
    <div className="md:w-1/2 px-5">
      <div className="text-right md:text-left"> {/* Align titles to the right on mobile, left on larger screens */}
        ...
        {AllEventsTitles.section1.title}
        </h1>
        <p className="text-white sm:text-sm text-xs text-center sm:ml-0">
        {AllEventsTitles.section1.subtitle}
        </p>
...
<section>
  ...
  <div className="xl:max-w-8xl mx-auto px-4">
    ...
    <p className="text-xl font-medium text-black">
      ...
      {/*Gallery */}
      <div className="grid grid-cols-3 lg:grid-cols-7 gap-4 pl-5 pr-5">
        {GlobalData.EventsImageData.map((movie) => (
          <div key={movie.id} className="relative">
            <div className="thumbnail-container">
              <img className="p-3" src={movie.thumbnail} alt={movie.name} />
              <div className="overlay"></div> {/* Black color overlay */}
